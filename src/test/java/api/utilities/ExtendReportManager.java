...
public class ExtendReportManager implements ITestListener
{
	...
	public ExtentReports extent; 				 // show common data like env infor, user infor, os, project name, module name
	public ExtentTest test;                      // for writing test or creating entries in the report, if any test fail then to add that entry in the report
